...
void action::openPiggyBank(ENetEvent &event, const std::string &header)
{
    ...
    const int banked = std::clamp(pPeer->piggy_gems, 0, ::peer::PIGGY_CAP);
    constexpr int cap = ::peer::PIGGY_CAP;
    ...
    send_varlist(event.peer, {
        ...
        std::format(
            ...
            "add_custom_label|750K|target:barBG_2;top:1.35;left:0.5;size:small;|\n"
            "add_custom_label|1.5M|target:barBG_2;top:1.35;left:1;size:small;|\n"
            "reset_placement_x|\n"
            "add_spacer|small|\n"
            ...
            "add_spacer|small|\n"
            "reset_placement_x|\n"
            "add_iap_button|rt_grope_loyalty_bundle02|`oPiggy Bank``||label:Buy {{price}};disabled:1;|\n"
            "add_spacer|small|\n"
            "add_spacer|small|\n"
            "end_dialog|||\n"
            "add_quick_exit|\n",
